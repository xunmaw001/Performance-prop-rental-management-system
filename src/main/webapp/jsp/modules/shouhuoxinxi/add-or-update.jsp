		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑收货信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>收货信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑收货信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">收货信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>物流状态</label>
										<textarea  name="wuliuzhuangtai" class="form-control" id="wuliuzhuangtai" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
									...
									<div class="form-group col-md-6">
										<label>发货时间</label>
										<div id="fahuoshijianDate" class="input-append date form_datetime">
											<input id="fahuoshijian-input" name="fahuoshijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shouhuoxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("shouhuoxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("shouhuoxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shouhuoxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#fahuoshijian-input").val(getCurDateTime());
			$("#fahuoshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#wuliuzhuangtai").val(ruleForm.wuliuzhuangtai);
			$("#zhanghao").val(ruleForm.zhanghao);	
			$("#fahuoshijian-input").val(ruleForm.fahuoshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.wuliuzhuangtai != null && res.data.wuliuzhuangtai != ''){

						$("#wuliuzhuangtai").val(res.data.wuliuzhuangtai);
					}
					...
					if(res.data != null && res.data != '' && res.data.fahuoshijian != null && res.data.fahuoshijian != ''){

						$("#fahuoshijian-input").val(res.data.fahuoshijian);
						$('#fahuoshijianFileName').val(res.data.fahuoshijian)
					}
