...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>道具类型管理</span></li>
								<li class="breadcrumb-item active"><span>道具类型列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="daojuleixingSearch" class="form-control form-control-sm" placeholder="请输入道具类型" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#daojuleixingSearch').val() != null && $('#daojuleixingSearch').val() != ''){
				searchForm.daojuleixing ="%" +  $('#daojuleixingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("daojuleixing/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				daojuleixing : searchForm.daojuleixing,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("daojuleixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"daojuleixing");
