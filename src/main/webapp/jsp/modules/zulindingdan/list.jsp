...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'daojuguihai','','[1]','已进行归还')");
			...
			crossBtn1.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'fahuoxinxi','','','')");
