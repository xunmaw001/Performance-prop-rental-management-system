...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shangjiaxingmingSearch" class="form-control form-control-sm" placeholder="请输入商家姓名" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#shangjiaxingmingSearch').val() != null && $('#shangjiaxingmingSearch').val() != ''){
				searchForm.shangjiaxingming ="%" +  $('#shangjiaxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("shangjia/page","GET",{
				...
				shangjiaxingming : searchForm.shangjiaxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
