...
<html>
	...
	<body>
			...
			<form class="layui-form login-form" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(198, 161, 106, 1)","backgroundColor":"#fff","borderRadius":"30px","borderWidth":"10px","width":"470px","borderStyle":"double","justifyContent":"center","height":"auto"}'>
				...
				<div class="title" v-if="true" :style='{"padding":"0","boxShadow":"0px 0px 0 0px rgba(110,22,64,.8)","margin":"5px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(255, 215, 0, 0)","color":"rgba(9, 0, 4, 1)","isshow":true,"borderRadius":"0","borderWidth":"0","width":"100px","lineHeight":"38px","fontSize":"14px","borderStyle":"solid"}'>用户注册</p></div>
