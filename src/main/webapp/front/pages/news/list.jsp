...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" :style='{"padding":"5px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"5px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0px","alignItems":"center","borderWidth":"0px","fontSize":"18px","borderStyle":"solid"}'>
