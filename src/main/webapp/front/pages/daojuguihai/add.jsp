			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zulinshijian" type="text" :readonly="ro.zulinshijian" name="zulinshijian" id="zulinshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">归还时间：</label>
						<div class="layui-input-block">
							<input type="text" name="guihaishijian" id="guihaishijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">归还证明：</label>
						<div class="layui-input-block">
							<textarea name="guihaizhengming" id="guihaizhengming">请输入归还证明</textarea>
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='guihaizhengming'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.guihaizhengming = true;
                                                continue;
                                        }
                                        if(o=='crossuserid'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					var guihaizhengming = tinymce.get('#guihaizhengming').getContent()
					data.guihaizhengming = guihaizhengming;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('daojuguihai/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('daojuguihai' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
