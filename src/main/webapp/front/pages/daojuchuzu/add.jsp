			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="daojuleixing" id="daojuleixing" lay-filter="daojuleixing"  >
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xiangxidizhi" type="text" :readonly="ro.xiangxidizhi" name="xiangxidizhi" id="xiangxidizhi" autocomplete="off" class="layui-input">
						</div>
					</div>
		            
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">道具详情：</label>
						<div class="layui-input-block">
							<textarea name="daojuxiangqing" id="daojuxiangqing">请输入道具详情</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					var daojuxiangqing = tinymce.get('#daojuxiangqing').getContent()
					data.daojuxiangqing = daojuxiangqing;
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('daojuchuzu/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('daojuchuzu' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
