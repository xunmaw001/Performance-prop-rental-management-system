			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="fahuoshijian" id="fahuoshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
						  ...
						  carousel.render({
							...
							width: '100%',
						  	...
						  	indicator: 'inside'
                                ...
                                jquery('#fahuoshijian').val(getCurDateTime());
				laydate.render({
					elem: '#fahuoshijian',
					type: 'datetime'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='fahuoshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.fahuoshijian = true;
                                                jquery('#fahuoshijian').val(obj[o]);
                                                continue;
                                        }
					}
				}
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('shouhuoxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('shouhuoxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
